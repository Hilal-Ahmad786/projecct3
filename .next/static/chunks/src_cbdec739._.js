...
"[project]/src/components/ParticleNetwork.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ParticleNetwork({ className = '' }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticleNetwork.useEffect": ()=>{
            ...
            const handleResize = {
                "ParticleNetwork.useEffect.handleResize": ()=>{
            ...
            const handleMouseMove = {
                "ParticleNetwork.useEffect.handleMouseMove": (e)=>{
                    const rect = canvas.getBoundingClientRect();
                    mouse.x = e.clientX - rect.left;
                    mouse.y = e.clientY - rect.top;
                }
            }["ParticleNetwork.useEffect.handleMouseMove"];
            const initParticles = {
                "ParticleNetwork.useEffect.initParticles": ()=>{
                    particles = [];
            ...
            const draw = {
                "ParticleNetwork.useEffect.draw": ()=>{
                    ...
                    particles.forEach({
                        "ParticleNetwork.useEffect.draw": (p, i)=>{
                            // Move
                            p.x += p.vx;
                            p.y += p.vy;
                            // Bounce off edges
...
_s(ParticleNetwork, "UJgi7ynoup7eqypjnwyX/s32POg=");
_c = ParticleNetwork;
var _c;
...
let trackPageView;
try {
    const analytics = __turbopack_context__.r("[project]/src/lib/analytics.ts [app-client] (ecmascript)");
...
class SecurityManager {
    ...
    static detectSuspiciousBehavior() {
        ...
        return !!(navigator.webdriver || window.__selenium_unwrapped || window.callPhantom);
    }
...
"[project]/src/components/SecurityGuard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SecurityGuard() {
    ...
    const debounce = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityGuard.useCallback[debounce]": (func, wait)=>{
            let timeout;
            return ({
                "SecurityGuard.useCallback[debounce]": (...args)=>{
                    clearTimeout(timeout);
                    timeout = setTimeout({
                        "SecurityGuard.useCallback[debounce]": ()=>func(...args)
                    }["SecurityGuard.useCallback[debounce]"], wait);
                }
            })["SecurityGuard.useCallback[debounce]"];
        }
    }["SecurityGuard.useCallback[debounce]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SecurityGuard.useEffect": ()=>{
            // Only run once
            ...
            if (document.readyState === 'complete') {
                ...
                return ({
                    "SecurityGuard.useEffect": ()=>window.removeEventListener('load', initializeSecurity)
                })["SecurityGuard.useEffect"];
            }
        }
    }["SecurityGuard.useEffect"], []);
    const initializeSecurity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityGuard.useCallback[initializeSecurity]": ()=>{
    ...
    const runSecurityChecks = async ()=>{
        try {
            ...
            if (cachedFingerprint) {
                ...
                const fp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SecurityManager"].generateFingerprint();
                fingerprintRef.current = fp;
                sessionStorage.setItem('sec_fp', fp);
            }
            // Light-weight suspicious behavior check
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SecurityManager"].detectSuspiciousBehavior()) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SecurityManager"].trackSuspiciousActivity('automation_detected', {
            ...
            const debouncedDevToolsCheck = debounce(()=>{
                ...
                if (devToolsOpen) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SecurityManager"].trackSuspiciousActivity('devtools_detected', {}, fingerprintRef.current);
                }
            }, 2000);
...
_s(SecurityGuard, "EJAdum0Wo5eT5gn1wbdmp7Gy5nw=");
_c = SecurityGuard;
var _c;
__turbopack_context__.k.register(_c, "SecurityGuard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/components/ReCaptcha.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useReCaptcha = ()=>{
    const executeReCaptcha = async (action)=>{
        if ("object" === 'undefined' || !window.grecaptcha) {
            return '';
        }
        try {
...
//# sourceMappingURL=src_cbdec739._.js.map