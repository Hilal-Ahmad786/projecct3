...
export default function PricingPage() {
    const t = useSectionTranslations('machineLearning.pricing');
                    ...
                    {packages.map((pkg, index) => (
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-8">
                                {pkg.features.map((feature, i) => (
                                    <li key={i} className="flex items-start gap-3">
                                        <CheckIcon className="w-5 h-5 text-indigo-500 flex-shrink-0 mt-0.5" />
                            ...
                            <Button
                                ...
                                size="lg"
                                className={`w-full ${pkg.highlighted ? '!bg-indigo-500 hover:!bg-indigo-600 !border-indigo-500' : ''}`}
                            >
                                {pkg.cta}
                            </Button>
                        </motion.div>
