...
export default function PricingPage() {
    const t = useSectionTranslations('digitalMarketing.pricing');
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {packages.map((pkg, index) => (
                        ...
                        >
                            {pkg.highlighted && (
                                <span className="inline-block bg-rose-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">
                                    Most Popular
                                </span>
                            )}
                            ...
                            <Button
                                ...
                                size="lg"
                                className={`w-full ${pkg.highlighted ? '!bg-rose-500 hover:!bg-rose-600 !border-rose-500' : ''}`}
                            >
                                {pkg.cta}
                            </Button>
                        </motion.div>
