...
export default function PricingPage() {
    const t = useSectionTranslations('uiUxDesign.pricing');
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {packages.map((pkg, index) => (
                        ...
                        >
                            {pkg.highlighted && (
                                <span className="inline-block bg-pink-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">
                                    Most Popular
                                </span>
                            )}
                            ...
                            <Button
                                ...
                                size="lg"
                                className={`w-full ${pkg.highlighted ? '!bg-pink-500 hover:!bg-pink-600 !border-pink-500' : ''}`}
                            >
                                {pkg.cta}
                            </Button>
                        </motion.div>
