...
export default function MobileServices() {
    const t = useSectionTranslations('serviceSubpages.mobile-development');
    ...
    const iconMap: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
        ...
        code: ArrowPathIcon, // Placeholder for Cross-Platform
        check: ShieldCheckIcon, // Placeholder for Testing/QA
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => {
                        const Icon = iconMap[feature.icon] || DevicePhoneMobileIcon;
                        return (
                            <motion.div
                                key={index}
