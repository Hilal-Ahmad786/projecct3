...
export default function ProjectDetailSection() {
  ...
  return (
    <section className="section gradient-bg-subtle relative overflow-hidden" dir={dir}>
        ...
        >
          ...
          `,
                ...
                <motion.div
                  ...
                  className={`absolute z-50 w-[100px] h-[75px] rounded-lg bg-white border border-gray-200/80 shadow-[0_4px_12px_rgba(0,0,0,0.05)] p-3 will-change-transform ${dir === 'rtl' ? 'left-[58%]' : 'right-[58%]'
                    } top-[65px]`}
                >
                  {/* Minimal status indicators */}
                ...
                <motion.div
                  ...
                  className={`absolute z-40 w-[85px] h-[85px] rounded-lg border border-gray-200/80 p-3 shadow-[0_3px_10px_rgba(0,0,0,0.04)] will-change-transform ${dir === 'rtl' ? 'right-[62%]' : 'left-[62%]'
                    } bottom-[55px]`}
