    ...
    return [
      {
        ...
        image: '/images/Demo/ecommerce-platform.png',
      ...
      },
      {
        ...
        image: '/images/Demo/business-automation.png',
      ...
      },
      {
        ...
        image: '/images/Demo/digital-marketing.png',
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  ...
                  {item.result && (
                    <p className="text-sm opacity-90">{item.result}</p>
                  )}
                </div>
              </div>
