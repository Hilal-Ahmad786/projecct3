...
export default function WebDevServices() {
    const t = useSectionTranslations('serviceSubpages.web-development');
    ...
    const iconMap: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
        globe: ComputerDesktopIcon,
        rocket: ShoppingCartIcon, // Using ShoppingCart as a placeholder/example or RocketLaunchIcon if available
        palette: DevicePhoneMobileIcon, // Placeholder mapping
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => {
                        const Icon = iconMap[feature.icon] || ComputerDesktopIcon;
                        return (
                            <motion.div
                                key={index}
