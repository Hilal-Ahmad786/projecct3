...
const serviceIcons: Record<string, React.ElementType> = {
  ...
  'accessibility-compliance': ShieldCheckIcon,
  ...
  'graphql-api-development': CubeIcon,
  'api-rate-limiting-throttling': FunnelIcon,
  'api-security-authentication': LockClosedIcon,
...
const serviceGradients: Record<string, string> = {
  ...
  'accessibility-compliance': 'from-teal-500/10 to-emerald-500/10 hover:from-teal-500/20 hover:to-emerald-500/20 border-teal-200/50',
  'real-time-applications': 'from-cyan-500/10 to-blue-500/10 hover:from-cyan-500/20 hover:to-blue-500/20 border-cyan-200/50',
  ...
  'graphql-api-development': 'from-pink-500/10 to-purple-500/10 hover:from-pink-500/20 hover:to-purple-500/20 border-pink-200/50',
  'api-rate-limiting-throttling': 'from-fuchsia-500/10 to-purple-500/10 hover:from-fuchsia-500/20 hover:to-purple-500/20 border-fuchsia-200/50',
  'api-security-authentication': 'from-indigo-500/10 to-purple-500/10 hover:from-indigo-500/20 hover:to-purple-500/20 border-indigo-200/50',
...
const serviceIconColors: Record<string, string> = {
  ...
  'accessibility-compliance': 'text-teal-600',
  'real-time-applications': 'text-cyan-600',
  ...
  'graphql-api-development': 'text-pink-600',
  'api-rate-limiting-throttling': 'text-fuchsia-600',
  'api-security-authentication': 'text-indigo-600',
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden" dir={dir}>
          ...
          <div className={`absolute ${dir === 'rtl' ? 'left-0' : 'right-0'} top-0 h-full w-[min(94vw,420px)] glass-strong border-l border-glass shadow-2xl overflow-y-auto`}>
                            ...
                            {Object.entries(serviceCategories).map(([catKey, cat]) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`flex items-center justify-center gap-1 px-2 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all border ${isActive ? 'bg-heritage-turquoise text-white border-heritage-turquoise shadow-sm' : 'bg-white text-gray-600 border-gray-200'}`}
                                >
