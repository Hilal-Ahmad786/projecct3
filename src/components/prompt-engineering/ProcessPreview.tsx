...
import { BeakerIcon, DocumentTextIcon, RocketLaunchIcon } from '@heroicons/react/24/outline';
    ...
    const steps = [
        {
            ...
            description: 'We analyze your AI use cases, understand desired outputs, and identify the optimal prompting strategies for your needs.',
            icon: BeakerIcon,
        },
        {
            number: '02',
            title: 'Prompt Development',
            description: 'Our experts design, test, and iterate on prompts using advanced techniques like chain-of-thought, few-shot learning, and structured outputs.',
            icon: DocumentTextIcon,
        },
        {
            number: '03',
            title: 'Optimization & Deployment',
            description: 'We optimize prompts for cost, latency, and quality, then integrate them into your production systems with monitoring.',
