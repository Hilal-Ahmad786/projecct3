...
import { LightBulbIcon, CpuChipIcon, ArrowPathIcon } from '@heroicons/react/24/outline';
    ...
    const steps = [
        {
            ...
            description: 'We map your business processes, identify automation opportunities, and design agent architectures that align with your goals.',
            icon: LightBulbIcon,
        },
        {
            number: '02',
            title: 'Agent Development',
            description: 'Our team builds intelligent agents with tool-use capabilities, memory systems, and decision-making logic tailored to your use cases.',
            icon: CpuChipIcon,
        },
        {
            number: '03',
            title: 'Orchestration & Scaling',
            description: 'We deploy multi-agent systems with proper orchestration, monitoring, and continuous improvement loops.',
            icon: ArrowPathIcon,
        },
    ];
