...
export const serviceSubpageData: Record<string, ServiceSubpageData> = {
  ...
  'web-development': {
    ...
    portfolio: {
      headline: 'Real Websites We Built',
      subtitle: 'Live Client Projects',
      description: 'These are live websites we have designed and developed for our clients. Each one is built with modern technology, optimised for performance and SEO.',
      items: [
        {
          title: 'HexTG – Corporate Website',
          industry: 'Technology',
          challenge: 'The client needed a professional, fast-loading corporate website that clearly communicated their services and generated inbound leads — with multilingual support from day one.',
          solution: 'We built the site on Next.js with TypeScript and Tailwind CSS, implementing server-side rendering for SEO, structured data, and a multilingual architecture using our custom i18n system.',
          results: [
            'Lighthouse performance score above 95 across all pages',
            'Fully responsive with seamless experience on mobile, tablet, and desktop',
            'Structured data and canonical tags implemented for maximum SEO coverage',
          ],
          stats: [
            { label: 'Performance Score', value: '95+' },
            { label: 'Languages Supported', value: '5' },
          ],
          projectUrl: 'https://hextg.com',
        },
        {
          title: 'Bursa Panorama – City Directory Platform',
          industry: 'Local Business & Tourism',
          challenge: 'A Bursa-based startup wanted a comprehensive city directory platform where residents and visitors could discover restaurants, venues, wedding halls, and entertainment spots.',
          solution: 'Built a full-stack Next.js platform with category-based search, venue listing pages, Google Maps integration, and a CMS for venue owners to manage their own profiles.',
          results: [
            'Launched with hundreds of local venue listings across multiple categories',
            'Search and filter system enabling discovery by category, district, and keywords',
            'Venue owner self-service portal for managing profiles and photos',
          ],
          stats: [
            { label: 'Venue Categories', value: '8+' },
            { label: 'Listing Pages', value: '200+' },
          ],
          projectUrl: 'https://bursapanorama.com',
        },
        {
          title: 'Ankara PERT – Used Car Buying Platform',
          industry: 'Automotive',
          challenge: 'Ankara PERT needed a fast lead-generation website where people selling damaged, crashed, or older vehicles could get an instant offer and book a pickup within 30 minutes.',
          solution: 'Designed and developed a conversion-optimised website with a WhatsApp CTA, direct call integration, and a clean service breakdown page — deployed with sub-1-second load times.',
          results: [
            'Prominent WhatsApp and call CTAs driving direct lead flow from day one',
            'Clear service pages explaining the 30-minute offer process',
        ...
        {
          title: '3X Yapı – Architecture Company Website',
          industry: 'Architecture & Construction',
          challenge: 'A modern architecture firm needed a website that showcased their portfolio with a premium feel, communicated their philosophy, and converted visitors into consultation bookings.',
          solution: 'Built a visually striking corporate website with large-format project imagery, smooth scroll animations, a services section, and a contact form integrated with email notifications.',
          results: [
            'Premium aesthetic reflecting the firm\'s high-end positioning',
            'Project portfolio with category-filtered case studies',
            'Mobile-optimised layout with fast load performance',
          ],
          stats: [
            { label: 'Performance Score', value: '92+' },
            { label: 'Portfolio Projects', value: '20+' },
          ],
          projectUrl: 'https://3xyapi.com',
        },
      ],
      aggregateStats: [
        { label: 'Websites Delivered', value: '30+' },
        { label: 'Avg. Performance Score', value: '93' },
        { label: 'Languages Supported', value: 'Up to 5' },
  ...
  'e-commerce': {
    ...
    portfolio: {
      headline: 'Real E-Commerce Stores We Built',
      subtitle: 'Live Client Projects',
      description: 'These are live e-commerce stores we have built for our clients — from industrial B2B catalogues to consumer toy shops, all powered by custom software and modern web technology.',
      items: [
        {
          title: 'SivTech Makina – Industrial Machinery E-Commerce',
          industry: 'Manufacturing & Industrial',
          challenge: 'SivTech Makina needed a custom e-commerce platform to sell industrial machinery online with a product catalogue, detailed spec pages, a quote-request system, and multilingual support for international buyers.',
          solution: 'We built a fully custom Next.js e-commerce platform with a structured product catalogue, request-for-quote (RFQ) workflow, admin panel for inventory management, and SEO-optimised category and product pages.',
          results: [
            'Full custom e-commerce platform live and processing quote requests',
            'Product catalogue with detailed specification pages and image galleries',
            'Multilingual support enabling outreach to international customers',
          ],
          stats: [
            { label: 'Platform', value: 'Custom Software' },
            { label: 'Languages', value: 'Multi-language' },
          ],
          projectUrl: 'https://sivtechmakina.com',
        },
        {
          title: 'Roket Oyuncak – Toy E-Commerce Store',
          industry: 'Retail & Consumer Goods',
          challenge: 'Roket Oyuncak, a Turkish toy retailer, needed a fully featured consumer e-commerce store with a large product catalogue, fast search, cart and checkout, and a clean brand experience to compete online.',
          solution: 'Delivered a high-performance e-commerce storefront with category navigation, product filtering, a secure checkout with payment gateway integration, and an admin dashboard for order and inventory management.',
          results: [
            'Full online store launched with hundreds of active product listings',
            'Secure checkout with integrated Turkish payment gateway',
            'Fast, mobile-optimised storefront with smooth product browsing',
          ],
          stats: [
            { label: 'Products Listed', value: '500+' },
            { label: 'Load Time', value: '<1.5s' },
          ],
          projectUrl: 'https://roketoyuncak.com',
        },
        {
          title: 'Speakup Online – EdTech Subscription Platform',
          industry: 'Education & E-Learning',
          challenge: 'Speakup Online needed a subscription-based platform where students could purchase English learning plans, book live sessions with teachers, and track their progress — all in a single experience.',
          solution: 'Built a Next.js platform with subscription billing, a session booking calendar, teacher profiles, and a student dashboard. Integrated with a payment processor for recurring plan management.',
          results: [
            'Subscription plan purchase and management flow fully automated',
            'Live session booking integrated with teacher availability calendar',
            'Clean, conversion-optimised landing page driving plan sign-ups',
          ],
          stats: [
            { label: 'Plan Types', value: '3 Tiers' },
            { label: 'Booking System', value: 'Live sessions' },
          ],
          projectUrl: 'https://speakup.com.tr',
        },
      ],
      aggregateStats: [
        { label: 'Stores Launched', value: '10+' },
        { label: 'Custom Platforms Built', value: '100%' },
